...
Substantive rubric/methodology/profile/trusted-code changes require a governance PR, seven-day public comment window, impact assessment and migration examples, explicit authorization from the sole human operator, adequatelimited, supported by automated review and validation and a future effective version/date. Proposed grading changes cannot judge/deploy themselves. Emergency protective action may pause/suppress affected services with an incident record and later review, but cannot secretly change earned credit. Migration preserves occupied family history and earning periods.
...
The operator explicitly confirmed that the site has one human operator and an automation agent. No second human governance approval is required. The seven-day public comment window remains in force unless the operator explicitly authorizes a release-specific exception. The [2026-09-07 inclusion-first release](grading/releases/2026-09-07-inclusion-first.md) is prepared and awaits that timing requirement or an explicit exception. Publish the reviewed governance PR through the trusted operator check and ordinary branch protections. It cannot assign research points, erase old judgments, or bypass CI.
